...
export async function generateMetadata({
  ...
  const doc = getLegalDocument("cerez-politikasi", currentLocale);

  return {
    title: doc?.metaTitle || "Çerez Politikası | Cebeci Medikal",
    description: doc?.metaDescription || "Cebeci Medikal çerez politikası.",
  };
}
