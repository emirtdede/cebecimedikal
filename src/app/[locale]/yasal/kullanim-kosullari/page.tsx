...
export async function generateMetadata({
  ...
  const doc = getLegalDocument("kullanim-kosullari", currentLocale);

  return {
    title: doc?.metaTitle || "Kullanım Koşulları | Cebeci Medikal",
    description: doc?.metaDescription || "Cebeci Medikal kullanım koşulları.",
  };
}
