...
export function BrandLogo({
  ...
  return (
    ...
    >
      ...
      {showSubtitle && (
        <span
          className="text-[10px] sm:text-[11px] font-semibold text-foreground-muted tracking-wider uppercase ltr:pl-[68px] -mt-1 hidden xs:block"
        >
          {subtitleText}
        </span>
      )}
