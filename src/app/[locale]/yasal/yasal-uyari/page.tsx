...
export async function generateMetadata({
  ...
  const doc = getLegalDocument("yasal-uyari", currentLocale);

  return {
    title: doc?.metaTitle || "Yasal Uyarı & Mevzuat | Cebeci Medikal",
    description: doc?.metaDescription || "Cebeci Medikal yasal uyarı bildirimi.",
  };
}
