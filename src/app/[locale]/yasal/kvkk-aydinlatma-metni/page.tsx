...
export async function generateMetadata({
  ...
  const doc = getLegalDocument("kvkk-aydinlatma-metni", currentLocale);

  return {
    title: doc?.metaTitle || "KVKK Aydınlatma Metni | Cebeci Medikal",
    description: doc?.metaDescription || "6698 sayılı KVKK aydınlatma metni.",
  };
}
