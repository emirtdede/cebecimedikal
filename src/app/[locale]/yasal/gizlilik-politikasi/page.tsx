...
export async function generateMetadata({
  ...
  const doc = getLegalDocument("gizlilik-politikasi", currentLocale);

  return {
    title: doc?.metaTitle || "Gizlilik Politikası | Cebeci Medikal",
    description: doc?.metaDescription || "Cebeci Medikal gizlilik politikası.",
  };
}
